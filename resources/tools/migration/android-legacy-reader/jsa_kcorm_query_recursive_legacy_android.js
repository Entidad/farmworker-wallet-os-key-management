 ...
 * @param {string} key
 * @param {string} query - e.g. Age=42 (empty = all objects of the entity)
 * @param {string} entity
 * @param {MxObject[]} output - output list to populate
 * @param {string} [sharedPreferencesName] - old SharedPreferences file. Defaults to "shared_preferences".
